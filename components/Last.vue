            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    <div class="mb-3 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            ...
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Weather
                                Forecast </span>
                        </a>
                    </div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="https://getbootstrap.com/" target="_blank"
                                        class="hover:underline">Bootstrap</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-1">
                                    <a href="https://github.com/Anamikalimbu" target="_blank"
                                        class="hover:underline ">Github</a>
                                </li>
                                <li class="mb-1">
                                    <a href="https://www.facebook.com/anamika.limbu.942" target="_blank"
                                        class="hover:underline">Facebook</a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/anamikalimbu06/" target="_blank"
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#"
                            class="hover:underline">Anamikacrew</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-1 space-x-5 sm:justify-center sm:mt-0">
                        <a href="https://www.facebook.com/anamika.limbu.942" target="_blank"
